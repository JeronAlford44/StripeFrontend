const items = [
    {
        ...
        image: 'https://media.istockphoto.com/id/1309717274/vector/realistic-black-modern-thin-frame-display-computer-monitor-vector-illustration-jpg.jpg?s=612x612&w=0&k=20&c=hWFdkv0V09HqWjqRy2w93ikw2RBAcoxrhXq_9AQsOhQ=',
    ...
    },
    {
        ...
        image: 'https://img.freepik.com/free-psd/smartphone-mockup_1310-812.jpg?size=626&ext=jpg&ga=GA1.1.553209589.1713744000&semt=ais',
        count: 0 // Initial count set to 0
    },
    {
        name: 'Tablet',
        ...
        image: 'https://images.unsplash.com/photo-1623126908029-58cb08a2b272?q=80&w=1000&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTh8fHRhYmxldHxlbnwwfHwwfHx8MA%3D%3D',
        count: 0 // Initial count set to 0
    },
    {
        name: 'Smartwatch',
    ...
    },
    {
        ...
        image: 'https://img.freepik.com/premium-psd/gaming-console-with-game-controller-3d-render-illustration_47987-10199.jpg',
        count: 0 // Initial count set to 0
    },
    {
    ...
    },
    {
        ...
        image: 'https://m.media-amazon.com/images/I/61YwaovfYFL._AC_UF1000,1000_QL80_.jpg',
        count: 0 // Initial count set to 0
    },
    {
        ...
        image: 'https://www.shutterstock.com/image-photo/3d-modern-wireless-wifi-black-260nw-1363170881.jpg',
        count: 0 // Initial count set to 0
    }
];
